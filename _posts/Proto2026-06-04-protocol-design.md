...
> **Screenshot 1: NCBI Sequence Page** > *(![alt text](image.png))*
...
> **Screenshot 2: BLAST Results** > *(![alt text](image-5.png))*
...
> **Screenshot 3: Multiple Sequence Alignment Output** > *(![alt text](image-3.png)![alt text](image-4.png))*
...
> **Screenshot 4: Final Phylogenetic Tree** > *(![alt text](image-2.png))*
...
> **Screenshot 5: Primer-BLAST Results** > *(![alt text](image-1.png))*
